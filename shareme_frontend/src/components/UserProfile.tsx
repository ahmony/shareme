            ...
            <div className="flex flex-col pb-5">
                <div className="relative flex flex-col mb-7">
                    <div className="flex flex-col justify-center items-center">
                        ...
                        <div className="absolute top-0 z-20 right-0 p-2">
                            {userId === user._id && (
                    ...
                    <div className="text-center mb-7 mt-2">
                        <button type='button'
                            onClick={(e: any) => { setText(e.target.textContent); setActiveBtn('created') }} className={`${activeBtn === 'created' ? activeBtnStyles : notActiveBtnStyles}`}>
                            Created
                        </button>
                        <button type='button'
                            onClick={(e: any) => { setText(e.target.textContent); setActiveBtn('saved') }} className={`${activeBtn === 'saved' ? activeBtnStyles : notActiveBtnStyles}`}>
                            Saved
                        </button>
                        ...
                        {pins?.length ? (
                            ...
                            </div>) : <p className='text-center'>Nothing found.</p>}
                    </div>
                </div>
            </div>
        </div>
